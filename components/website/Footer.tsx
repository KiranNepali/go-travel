...
function Footer({}: Props) {
  return (
    ...
    <div className="w-full mx-auto ] rounded-3xl relative flex items-center justify-center bg-black">
        ...
        <div className="w-11/12 z-20  px-4 text-zinc-50 flex flex-col">
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-5 flex-row justify-between">
              ...
              <div className="flex  w-9/12 justify-around text-sm font-semibold">
                <a className="hidden md:block cursor-pointer text-zinc-200 hover:text-zinc-50 uppercase">
                  About
                </a>
                <a className="hidden md:block cursor-pointer text-zinc-200 hover:text-zinc-50 uppercase">
                  Services
