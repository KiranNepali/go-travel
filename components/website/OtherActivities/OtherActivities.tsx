...
import AcitvityDetail from "./AcitvityDetail";
        ...
        <div className="w-full">
          <div className="w-full grid gap-3 grid-cols-4 place-content-center place-items-center">
            {OtherActivitiesData.map((item) => (
              <div
                key={item.id}
                className="w-full rounded-3xl cursor-pointer group relative overflow-hidden flex justify-center items-center h-[30vh] bg-slate-300"
              >
