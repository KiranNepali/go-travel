    ...
    <>
      ...
      >
        ...
        <div className="z-20 relative h-full pt-[5rem] flex justify-center items-center w-full flex-col gap-5 ">
          <span className="service-title text-zinc-50 text-start  text-2xl md:text-5xl uppercase font-semibold">
            Why chose us ?
          </span>
          {/* h-0 opacity-0 */}
          <div className="service-card-container text-zinc-50  w-full  flex justify-center items-center">
