...
//     <>
//       {/* top  */}
//       <div className="w-full text-zinc-50  px-[10%] z-[1000] fixed top-0 left-0 h-[5rem] md:h-[10rem] flex justify-between items-center">
//         {/* logo  */}
...
//       <div
//         ref={sideNavRef}
//         className="w-full h-screen  justify-center items-center hidden text-zinc-50 z-[500] fixed top-0 right-[-100%] bg-zinc-900"
//       >
...
//       <button className="start-button border-[2px] fixed border-zinc-300  cursor-pointer bg-zinc-800  text-zinc-50 hover:bg-zinc-900  hover:scale-95 duration-200   bottom-[15%] z-[100]  left-[50%] translate-x-[-50%] px-10 py-2 text-nowrap rounded-3xl text-[12px] font-semibold">
//         START TOUR
//       </button>
...
//             <span className="cursor-pointer w-full hover:scale-110 duration-200 text-zinc-100 hover:text-zinc-50">
//               {item}
//             </span>
//           ))}
//         </div>
//         {/* bottom dot  */}
//         <div className="w-full md:w-auto text-end text-[12px] text-zinc-50">
//           {" "}
//           &copy; Copyright WebX
//         </div>
//       </div>
    ...
    //     className="w-full  h-0  bg-zinc-900 text-zinc-50  left-0 overflow-hidden"
    //   >
